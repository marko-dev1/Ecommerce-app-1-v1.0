...
class ProductController {
  ...
  static async getAllProducts(req, res) {
    try {
      const { category } = req.query; // Add query parameter support
  ...
  static async getProductsByCategory(req, res) {
    try {
      ...
      const products = await ProductService.getProductsByCategory(decodedCategory);
      ...
      const productsWithCorrectUrls = products.map(product => ({
        ...
        image_url: product.image_url ? 
          ...
          '/uploads/logo.png' // Default image if none exists
      }));
  ...
  // Show new arrivals (latest 3 months products) 
  ...
  static async getNewArrivals(req, res) {
    try {
        ...
        const products = await ProductService.getNewArrivals(threeMonthsAgo);
